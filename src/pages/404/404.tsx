            ...
            <div className="content" id="nopage">
                <div className="split">
                    <div className="text" style={{width: "100%"}}>
                        ...
                        <img src="https://fljzgwpfjpgvhixuacrm.supabase.co/storage/v1/object/public/images/404.png"
                             style={{width: "50%", margin: "auto auto"}} id="vertical"/>
                        <a href="/">
                            <div className="return-home">Return Home</div>
                        </a>
                    </div>
                    <img src="https://fljzgwpfjpgvhixuacrm.supabase.co/storage/v1/object/public/images/404.png"
                         style={{width: "100%"}} id="horizontal"/>
                </div>
            </div>
            <Footer/>
        </>
