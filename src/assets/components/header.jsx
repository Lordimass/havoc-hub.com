        ...
        <div className="header">
            ...
            <div className="nav-container"><div className="nav" id="archive" onClick={goToArchive}>
                ...
                <div className="dropdown">
                    <a href="/archive/2020" id="s2020" className="year">2020</a>
                    <a href="/archive/2021" id="s2021" className="year">2021</a>
                    <a href="/archive/2022" id="s2022" className="year">2022</a>
                    <a href="/archive/2023" id="s2023" className="year">2023</a>
                    <a href="/archive/2024" id="s2024" className="year">2024</a>
                    <a href="/archive/2025" id="s2025" className="year">2025</a>
                </div>
            </div>
